...
class Frame (tk.Frame):
    ...
    def campos_peliculas(self):
        ...
        self.boton_cancelar.config(width=20,font=('Arial', 12,'bold'), fg='#DAD5D6', bg='#DB152E',
    ...
    def tabla_peliculas(self):
        #Rcuperar la lista de peliculas
        self.lista_peliculas = listar()

        self.tabla= ttk.Treeview(self,
        column=('Nombre','Duracion','Gneero'))
        self.tabla.grid(row=4, column=0, columnspan=4, sticky='nse')

        #Scrollbar para la tabla si excede a las 10 registros
        ...
        for pelicula in self.lista_peliculas:
            self.tabla.insert('',0,text=pelicula[0],
            values =(pelicula[1],pelicula[2],pelicula[3]))
        ...
        self.boton_eliminar.config(width=20,font=('Arial', 12,'bold'), fg='#DAD5D6', bg='#DB152E',
                                cursor='hand2',activebackground='#E15370')
    ...
    def editar_datos(self):
        try:
            ...
            mensaje = 'No se ha selecionado ningun registro'
    ...
    def eliminar_datos(self):
        try:
            ...
            mensaje= 'Nose ha selecionado ningun registro'
            messagebox.showerror(titulo, mensaje)